...
/**
 * fun_push - push data in struct
 * @stack: p-t-p to struct
 * @nline: line number
 */
...
/**
 * fun_pall - prints the data of all nodes in stack
...
/**
 * fun_pint - prints form top of stack
 * @stack: p-tp
 * @nline: the line number
 */
...
/**
 * fun_pop - removes the top element of stack
 * @stack: p-tp
 * @nline: the line number
 */
